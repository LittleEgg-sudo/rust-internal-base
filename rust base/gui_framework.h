...
namespace mid_framework
{
	...
	auto begin(std::string cheat_name) -> void
	{
		...
		functions::fill_box({ position.x, position.y, resolution.x, 26 }, { 0.130f, 0.130f, 0.130f, 1 });
		functions::fill_box({ position.x, position.y, resolution.x, 25 }, { 0.090f, 0.090f, 0.090f, 1 });
